...
date = 2025-07-15T19:32:07+03:00
draft = true
...
In order to use it you will need to source its environment variables using:
```bash
source /opt/poky/2.4.2/environment-setup-x86-pokymllib32-linux
```

Once this is done you can check the value of $CXX and see it is defined with the cross compiler
of the toolchain, meaning you can use:
```bash
$CXX hello_world.cpp
```

To compile your code, then copy it onto the Raspberry Pi4 and it should work
with no archive or linking issues.
